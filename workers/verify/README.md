...
## API
`POST /verify` body `{ "key": "...", "instanceName": "..."?, "instanceId": "..."? }`
...
> ⚠️ 기기 1대(activation limit=1): 기기 교체 시 LS에서 기존 instance 해제 후 재활성화. instance 없는 validate로 폴백하지 않으므로 한도가 실제로 적용된다.
