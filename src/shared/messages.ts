...
export type CodeToUi =
  ...
  | { type: 'APPLY_RESULT'; bound: number; skipped: number; flags: string[]; reasons: Record<string, number>; preview?: boolean; cancelled?: boolean }
  ...
  | { type: 'HISTORY'; entries: HistoryEntry[] } // M3.1(Paid): 변경 이력
