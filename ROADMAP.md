...
- **Free(무제한)**: 추출 · 바인딩 · 리네임 · 변수 편집 · 닮은 프레임 스캔 · 명도 대비 점검 · 코드 내보내기
...
### 8.5 신규 · 정리
- [x] 명도 대비 **후속 보정**(텍스트색 기본 + 배경 옵션) — `suggestContrastFix`(OKLCH L 이분 탐색) + 행별 ‘텍스트/배경’ 적용(`APPLY_CONTRAST_FIX`) `(PR #37)`
