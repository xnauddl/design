...
- [x] **툴팁·선택지·자리표시자 외부화** — `data-i18n-title`/`data-i18n-placeholder` + option `data-i18n` + 동적 UI `t()` · `verify-i18n` 속성 짝 검사 (px/rem·Free/Paid 제외)
...
- **Free(무제한)**: 추출 · 바인딩 · 리네임 · 변수 편집 · 닮은 프레임 스캔 · 코드 내보내기
- **Paid**: 위 전부 + 팔레트 생성/적용 · 토큰(3계층 변수) 생성 · 시맨틱 매핑 · 컴포넌트/베리언트(Phase 3/4/4.1) · 닮은 프레임 컴포넌트화 · 텍스트 스타일 · 다크 테마 생성 · 공유 프리셋
...
- [x] **M3 — 공유 프리셋(Paid)**  _(변경 이력은 v2 재설계에서 제거 — PR #37)_
