...
test('createTokens — Global 리터럴 + Semantic 별칭 + scopes/hidden + px 스냅샷', async () => {
  ...
  // 색(글로벌+시맨틱) 2 + 라인하이트(글로벌 STRING + px FLOAT + 시맨틱) 3 + 간격 2 = created 7
  assert.deepEqual(summary, { created: 7, updated: 0, globals: 4, semantics: 3 });
  ...
  // 비-px lineHeight: Global은 STRING '150%', px 스냅샷 FLOAT 24
  ...
  const gLhPx = findVar(figma, 'Global', 'line-height/150-px');
